    ...
    <footer class="footer">
            <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
                ...
                <ul class="flex items-center space-x-8">
                  ...
                  <li>
                    <a href="https://github.com/Xelus22" target="_blank" class="text-white hover:text-gray-400">
                  ...
                  <li>
                    <a href="https://twitter.com/dank" target="_blank" class="text-white hover:text-gray-400">
